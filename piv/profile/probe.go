...
// AIDPIV is the PIV applet AID (NIST SP 800-73-4 Part 1, §2.2).
//
// The full standard AID is A0 00 00 03 08 00 00 10 00 01 00 but
// SELECT accepts the truncated 5-byte form because cards perform
// AID matching by prefix. This matches scp11.AIDPIV; the value is
// duplicated here so the profile package does not have to import
// scp11 (which would pull the SCP11 protocol stack into a probe
// path).
...
// two APDUs above are the entire probe surface.
