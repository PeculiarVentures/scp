...
// rather than FAIL.
//
// With --full set, the registry is walked via GET STATUS (GP §11.4.2)
// across three scopes: ISD, Applications + SSDs, and Load Files +
// Modules. Cards that require authentication for any of these scopes
// surface as SKIP; the unauthenticated path keeps 'sd info' a
// non-destructive probe regardless of whether --full is specified.
//
